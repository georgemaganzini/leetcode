...
function find_Kth_smallest(lists, k) {
  ...
  // take the smallest(i.e., top) element form the min heap, if the running count is
  ...
  while (minHeap.length > 0) {
    ...
    // if the array of the top element has more elements, add the next element to heap
    if (list.length > i + 1) {
